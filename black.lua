...
ControllerAll = false
local ListSudos ={Sudo_Id,1951693700,6666}
...
msg.Name_Controller = 'المبرمج خالد '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6666 then
...
return send(msg_chat_id,msg_id,' ⌯ اطلق دkol,,  ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n ⌯ نورت الكروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
{
{text = '⌯ Source Black ⌯️', url = 't.me/M_D_I'},
}
}
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من الkol,, ات قبل كدة 🙃 ").Reply,"md",true)  
else
Redis:srem(black.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من الkol,, ات لازم ياخد دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من الmtohd,, ين بعد ما اتعالج😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "mtohd,, ه" then
if not Redis:sismember(black.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(black.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ الklb,,  دا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
...
if TextMsg == "hmar,, " then
if not Redis:sismember(black.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ الhmar,,  دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(black.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من الhmer,,  تعال نفك الكارو منك😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "smb" then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من الsmbb,,  لازم ياخد دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "krd,, " then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله من قايمه الkroad,,  تعال نزلو من الشجره😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "ara,, " then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ خير اهو شغل مخك اهو نزلناك من الاgbe,, اء🌚 ").Reply,"md",true)  
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ محطوط ف قايمة الkol,, ات من  بدري 😂 ").Reply,"md",true)  
else
Redis:sadd(black.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته kol,,  بالمجموعة لما يسترجل هننزلو 😂  ").Reply,"md",true)  
end
end
if TextMsg == "وتكه" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه mtohd,,   كنت شاكك فيه انو سايكو😂  ").Reply,"md",true)  
end
end
if TextMsg == "mtohd,, ه" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه klb,,  خليه يجي ياخد عضمه😂  ").Reply,"md",true)  
end
end
if TextMsg == "hmar,, " then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه hmar,,  خليه يجي نركبلو عربية كرو😂  ").Reply,"md",true)  
end
end
if TextMsg == "smbb,, " then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(black.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return send(msg.chat_id,msg.id,'*\n ⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه smbb,,  في الكروب عقبال ميبقا زي النسوان الي تعبينو 😂  ").Reply,"md",true)  
end
end
if TextMsg == "krd,, " then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه krd,,  في الكروب تعال خدلك موزه  😂  ").Reply,"md",true)  
end
end
if TextMsg == "ara,, " then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه ara,,  في الكروب قولو عيب كده 😂  ").Reply,"md",true)  
end
end
if TextMsg == "gbe,, " then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ هو كده كده محطوط ف قايمة الاgbe,, ة  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(black.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم رفعه gbe,,  المجموعة  😂  ").Reply,"md",true)  
end
end
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد kol,, ات حاليا , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الkol,, ات  \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الkol,, ات', data = msg.sender.user_id..'/Delkholat'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ مفيش mtohd,, ين هنا كلهم اتعالجو 😂😂 , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الmtohd,, ين  \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الmtohd,, ين', data = msg.sender.user_id..'/Deltwhd'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الكلاب' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ مفيش hmer,,  هنا 😂😂 , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الhmer,,   \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الhmer,, ', data = msg.sender.user_id..'/Delmar'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'العرر' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ مفيش smbb,, اويه هنا 😂😂 , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الsmbb,,   \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الsmbb,, ', data = msg.sender.user_id..'/Delsmb'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الkroad,, ' then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(black.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return send(msg.chat_id,msg.id,'*\n ⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ مفيش kroad,,  هنا يصحبي 😂😂 , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الkroad,,   \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الkroad,, ', data = msg.sender.user_id..'/Del2rd'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الاgbe,, اء' then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(black.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return send(msg.chat_id,msg.id,'*\n ⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ مفيش اgbe,, ه هنا يصحبي 😂😂 , ","md",true)  
end
ListMembers = '\n* ⌯ قائمه الاgbe,, ه  \n ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الاgbe,, اء', data = msg.sender.user_id..'/Del8by'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
-----------تسلية-------
...
if UserId == "1951693700" then
return send(msg_chat_id,msg_id,"\n* ⌯ عذرآ لا تستطيع استخدام الامر على المبرمج خالد *","md",true)  
end
if UserId == "6666" then
...
if text == 'اسمي' then
LuaTele.sendText(msg.chat_id,msg.id," * ⌯ اسمك : *( `"..LuaTele.getUser(msg.sender.user_id).first_name.."` )","md",true)  
return false
end
if text == 'ايديي' then
LuaTele.sendText(msg.chat_id,msg.id,"* ⌯ ايديك : *( "..msg.sender.user_id.." *)*","md",true)  
return false
end
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ⌯ تم قفـل دkol,,  الاعضاء").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ⌯ تم فتح دkol,,  الاعضاء").unLock,"md",true)  
return false
end 
...
data = {
{
{text = '⌯ Source Black ⌯️', url = 't.me/'..chsource..''}, 
},
}
}
...
if TextMsg == 'الkol,, ات' then
local Info_Members = Redis:smembers(black.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد kol,, ات حاليا , ","md",true)  
end
Redis:del(black.."kholat:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الkol,, ات *","md",true)
end
if TextMsg == 'الkroad,, ' then
local Info_Members = Redis:smembers(black.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد kroad,,  حاليا , ","md",true)  
end
Redis:del(black.."2rd:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الkroad,,  *","md",true)
end
if TextMsg == 'الاgbe,, اء' then
local Info_Members = Redis:smembers(black.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد اgbe,, ة حاليا , ","md",true)  
end
Redis:del(black.."8by:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الاgbe,, ه *","md",true)
end
...
if TextMsg == 'الsmbb,, ' then
local Info_Members = Redis:smembers(black.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد smbb,, اويه حاليا , ","md",true)  
end
Redis:del(black.."smb:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الsmbb,, اويه *","md",true)
end
if TextMsg == 'الhmer,, ' then
local Info_Members = Redis:smembers(black.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد hmer,,  حاليا , ","md",true)  
end
Redis:del(black.."mar:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الhmer,,  *","md",true)
end
if TextMsg == 'الmtohd,, ين' then
local Info_Members = Redis:smembers(black.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⌯ لا يوجد mtohd,, ين حاليا , ","md",true)  
end
Redis:del(black.."twhd:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⌯ تم مسح {"..#Info_Members.."} من الmtohd,, ين *","md",true)
end
...
if text == 'المبرمج' or text == 'مبرمج' or text == 'خالد'  then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = ' Developer Khaled', url = 't.me/E_M_K'}, 
},
}
}
return send(msg_chat_id,msg_id,"[Developer Khaled](tg://user?id=1951693700)","md",true, false, false, true, reply_markup)
end
...
if text == "غنيلي" then
local t = "تم اهداء لك  اغنية  عشوائيه من البوت"
...
keyboard.inline_keyboard = {
{
{text = ' اغنية   اخرى ', callback_data=msg.sender.user_id.."/songg"},
},
}
local rep = msg.id/2097152/0.5
...
{{text = ' ⌯ Source Black ⌯️', url = "https://t.me/M_D_I"}},
}
}
return send(msg_chat_id,msg_id, [[*
...
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    ...
    return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"تم رفعه بـ قلبك").Reply,"md",true)  
  end
end
if text == "تنزيل من قلبي" then 
  ...
  if tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    ...
    return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"تم تنزيله من قلبك").Reply,"md",true) 
elseif tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت gbe,,  تنزل نفسك؟؟","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(black) then
  return send(msg_chat_id,msg_id,"ابعد عنيي","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return send(msg_chat_id,msg_id,"هو اصلاً مو بـ قلبك","md")
  end
end
if text == "انا بقلب من" then
  if not Redis:get(black..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return send(msg_chat_id,msg_id,"استريح منت بـ قلب احد","md")
  elseif Redis:get(black..msg_chat_id..msg.sender.user_id.."in_heart:") then
    ...
    return send(msg_chat_id,msg_id,"انت بـ قلب ["..heart_name.."](tg://user?id="..in_heart_id..")","md")
  end
end
if text == "تاك للي بقلبي" or text == "تاك لقلبي" or text == "تاك للناس الي بقلبي" then
  local heart_list = Redis:smembers(black..msg_chat_id..msg.sender.user_id.."my_heart:")
  if #heart_list == 0 then
    return send(msg_chat_id,msg_id,"قلبك فارغ","md")
  elseif #heart_list > 0 then
    your_heart = "الناس الي بـ قلبك \nــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ\n"
...
if text == "مسح للبقلبي" or text == "مسح البقلبي" then 
...
return send(msg_chat_id,msg_id,"تم مسح الي بـ قلبك","md")
end
-------
-- ttgwzine
...
return send(msg_chat_id,msg_id,"ماعدنا حد للزواج","md")
end
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  ...
  {text = 'ماني موافق', data = msg.sender.user_id..'/no_zw/'..member_id},
  },
  }
  }
return send(msg_chat_id,msg_id,"جبتلك عروس حلوه"..mem_tag.."شرايك فيها؟","md",false, false, false, false, reply_markup)
end
end
...
if tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"انتو متزوجين اصلاً ","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
...
return send(msg_chat_id,msg_id,"بنادي زوجها\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحق بيسرقو زوجتك","md")
elseif Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  ...
  local zwg_info = LuaTele.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"بنادي زوجتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحقي بيتزوج عليك","md")
...
local reply_markup = LuaTele.replyMarkup{
  ...
  {text = 'ماني موافقه', data = Message_Reply.sender.user_id..'/no_z/'..msg.sender.user_id},
  },
  }
  }
return send(msg_chat_id,msg.reply_to_message_id,"يا "..rep_tag.."\nالحلو هذا"..user_tag.."\nطالب ايدك للزواج شرايك؟","md",false, false, false, false, reply_markup)
end
end
if text == "زوجتي" then
  if Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    ...
    return send(msg_chat_id,msg_id,"شوفي يا ["..zwga_name.."](tg://user?id="..zwga_id..") زوجك ","md")
  elseif not Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    return send(msg_chat_id,msg_id,"انت مو متزوج اصلاً ","md")
  end
end
if text == "زوجي" then
  if Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    return send(msg_chat_id,msg_id,"شوف يا ["..zwga_name.."](tg://user?id="..zwga_id..") زوجتك ","md")
  elseif not Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    return send(msg_chat_id,msg_id,"انت مو متزوجة اصلاً ","md")
  end
end
if text == "انتي طالق" and  msg.reply_to_message_id ~= 0 then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت gbe,,  تطلق نفسك؟؟ ","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(black) then
  return send(msg_chat_id,msg_id,"ابعد عني","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"مو زوجتك اصلاً ","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(black..msg_chat_id..msg.sender.user_id.."mtzwga:")
    return send(msg_chat_id,msg_id,"تم الطلاق العيال اتشردو","md")
  end
end
if text == "انت طالق" and  msg.reply_to_message_id ~= 0 then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت gbe,, ة تطلقي نفسك؟؟ ","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(black) then
  return send(msg_chat_id,msg_id,"ابعدي عني","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"مو زوجك اصلاً ","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(black..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(black..msg_chat_id..msg.sender.user_id.."mtzwga:")
    return send(msg_chat_id,msg_id,"تم الطلاق العيال تشردو ","md")
  end
end
...
return send(msg.chat_id,msg.id,"•   انت بالسجن 🏤  انتظر ( "..time_ex.." )","md",true)
end
...
send(msg.chat_id,msg.id, "•  مسكتك الشرطة وانت تزرف \n✦","md",true)
end
else
send(msg.chat_id,msg.id, "•  ماعنده حساب بنكي ","md",true)
end
...
local jobs = {"طيار","محامي","دكتور","خباز","مدير بنك","قلب خالد","مدرس"," قاضي"}
...
return send(msg.chat_id,msg.id,"• ما عندك اي فلوس تشتري فيها")
end
...
return send(msg_chat_id,msg_id,'*يهلا ارحب*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*وعليكم السلام ورحمة الله وبركاته*',"md",false, false, false, false, reply_markup)
end
if text == 'باي' or text == 'مع سلامه' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*الله معك*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*لاعيب*',"md",false, false, false, false, reply_markup)
end
if text == 'النبي' or text == 'صل على النبي' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'* عليه افضل الصلاة واتم التسليم*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'* بخير الحمدلله*',"md",false, false, false, false, reply_markup)
end
if text == 'شلونك' or text == 'شخبارك' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*يهلاا ومسهلاا*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*تدوم يارب*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*سبحان الله وبحمده*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*صباح العافية*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*مساء النور*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*ونا بعد*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*هلا فيك*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*نورك عمري*',"md",false, false, false, false, reply_markup)
end
end
if text == "الردود" then
if not msg.Manger then
...
local t = "تم اهداء لك ستوري عشوائي"
local rep = msg.id/2097152/0.5
...
local t = "تم اهداء لك اغنية عشوائيه"
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == 'Barloo' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧫ ⌯ Source Black ⌯️️ ⧫',url="t.me/M_D_I"}},
}
local msg_id = msg.id/2097152/0.5
...
local datar = {data = {{text = "⌯ Source Black ⌯" , url = 'https://t.me/M_D_I'}}}
for i = 1,5 do
...
send(msg.chat_id,msg.id,"• للمبرمج خالد فقط")
end
end
end
if text then
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source'or text == 'ياسورس' then
photo = "https://t.me/vu75fy76b/5"
local T =[[
ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ
 ⌯ Source Black ⌯
ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ
 ⌯ Dev >> [˹ Khaled .](t.me/E_M_K)
ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ 
  ⌯ >> [˹ Source Black .](t.me/M_D_I)
ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ ــ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
Maany_Rand = {"krd,, ","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(black.."Game:Meaningof"..msg.chat_id,name)
name = string.gsub(name,"krd,, ","🐒")
...
if text == "امثله" then
if Redis:get(black.."Status:Games"..msg.chat_id) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","krd,, ","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
...
name = string.gsub(name,"الkrd,, ","__بعين امه غزال")
...
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'حذ', 'حذف رد')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ش', 'شعر')
return send(msg_chat_id,msg_id,[[*
...
data = {
{
{text = 'مطور السورس ⌯ ',type = 'text'},{text = '⌯ Source Black ⌯️',type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,"⌯ Source Black ⌯️ - @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
if tonumber(Message_Edit.sender.user_id) == 6666 then
...
caption = '٭ تم اهداء لك  اغنية  عشوائيه من البوت\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' اغنية   اخرى ', callback_data=IdUser.."/songg"},
},
}
...
data = {
{
{text = 'العاب السورس ', data = IdUser..'/normgm'}, {text = 'العاب متطورة ', data = IdUser..'/degm'}, 
},
{
{text = 'القائمه الرئيسيه', data = IdUser..'/helpall'},
},
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser," ⌯ تم قفـل الدkol,, ").Lock, 'md', true, false, reply_markup)
end
...
{
{text = GetSetieng(ChatId).lock_join, data = '&'},{text = 'الدkol,,  : ', data =IdUser..'/'.. 'Status_joine'},
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = 'قفل الدkol,, ', data =UserId..'/'.. 'lock_joine'},
},
{
{text = 'فتح الدkol,, ', data =UserId..'/'.. 'unlock_joine'},
},
{
{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},
},
...
edit(ChatId,Msg_id," ⌯ عليك اختيار نوع القفل او الفتح على امر الدkol,, ", 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser," ⌯ تم فتح الدkol,, ").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع kol,, ات المجموعة", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع mtohd,, ين المجموعة", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع hmer,,  المجموعة", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع الsmbb,,  الي هنا ف المجموعة", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع الkroad,, ", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id," ⌯ تم مسح جميع الأgbe,, اء", 'md', false)
end
